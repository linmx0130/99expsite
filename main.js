...
var app = new Vue({
  ...
  data: {
    ...
    problems: [
        ...
        {text: '800米必锻号码牌每种颜色各有多少张？', type: 'text', 
            choice: [{text:'27张', isChosen: false}, 
                     {text:'38张', isChosen: false}, 
                     {text:'44张', isChosen:false}, 
                     {text:'50张', isChosen:false}], userChoice:null},
        ...
        {text: '有体育课的同学一学期需要刷多少次锻？', type: 'text', 
            choice: [{text:'22次', isChosen: false}, 
                     {text:'24次', isChosen: false}, 
                     {text:'26次', isChosen:false}, 
                     {text:'28次', isChosen:false}], userChoice:null},
    ...
    final_problem :{text: '为什么九十九度杂志社不叫百度杂志社？', type: 'text', 
            choice: [{text:'因为9月9号是创始人的生日', isChosen: false}, 
